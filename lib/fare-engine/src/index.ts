...
export const MASTER_FARE_CONFIG = {
  ...
  routes: [
    ...
    route("pos-west-near", "POS ↔ West Near", ["pos", "west-near"], [300, 400, 550, 800, null], [500, 600, 750, 1000, null]),
    route("pos-west-mid", "POS ↔ West Mid", ["pos", "west-mid"], [375, 475, 625, 950, null], [600, 700, 850, 1200, null]),
    route("pos-west-far", "POS ↔ West Far", ["pos", "west-far"], [500, 600, 775, 1100, null], [800, 950, 1100, 1400, null]),
    route("west-central", "WEST ↔ Central", ["west-near", "central"], [400, 500, 675, 900, null], [650, 750, 900, 1200, null]),
    route("intra-west", "Intra-West", ["west-near"], [175, 225, 300, 500, null], [300, 375, 500, 700, null], "Applies to all approved West subgroups."),
